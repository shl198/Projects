    ...
    if Trim == 'True':
        ...
        for fastq, trimFastq in zip(fastqFiles, trimmedFiles):
            if len(fastq) ==2:
                ...
                '{Trimmed1} unpair1.fq.gz {Trimmed2} unpair2.fq.gz SLIDINGWINDOW:5:10 LEADING:2 '
                'TRAILING:2 MINLEN:36').format(Trim = Trimmomatic,thread = '2', 
                ...
                Trim = Trimmomatic,thread = '2',input = fastq[0],output =trimFastq[0],
