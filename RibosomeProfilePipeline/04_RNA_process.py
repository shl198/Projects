...
#===============================================================================
#                         1. get total count of all genes 
#===============================================================================
...
# countFiles = [f for f in os.listdir(bam_path) if f.endswith('count.txt')]
# countFiles = natsorted(countFiles)
# #------------ gene id mapping ------------
# for f in countFiles:
#     cmd = ('mv {f} {path}').format(f=f,path=count_path)
#     subprocess.call(cmd.split())
# geneSymbol2EntrezID(gene_id_symbol_file,count_path,count_path,sym2ID='yes')
# read exon position file
# #------------ get gene length ------------- 
...
#     return gene_length
# os.chdir(count_path)
# rna_count_files = [f for f in os.listdir(count_path) if f.endswith('Count.txt')]
...
#     df = pd.read_csv(f,sep='\t',header=0,names=['GeneID','count'])
#     if gene_length == []:
